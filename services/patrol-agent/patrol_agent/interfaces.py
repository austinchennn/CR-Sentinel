...
class WriteClient(Protocol):
    ...
    def write_episode(self, *, ip, risk_level, attack_type, reasoning_summary, action_taken, embedding, idempotency_key: str) -> None: ...
    def write_task(self, task_type, payload, idempotency_key: str) -> None: ...
    def write_alert(self, severity: str, message: str, idempotency_key: str) -> str: ...
